...
/**
 * Link across to the field app — the phone-sized companion that residents and
 * volunteers actually use, kept at `coastguard-ai.html` and mirrored into
 * `public/mobile.html` by `npm run sync-mobile`.
 *
 * It opens in a new tab so the dashboard keeps its simulation state; the
 * label says so, because a link that steals your tab without warning is a
 * genuine accessibility problem.
 */
